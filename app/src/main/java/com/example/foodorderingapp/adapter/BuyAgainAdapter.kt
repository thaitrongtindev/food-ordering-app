...
class BuyAgainAdapter(private val buyAgainFoodName : MutableList<String>,
    ...
    private val buyAgainImage: MutableList<Int>) : RecyclerView.Adapter<BuyAgainAdapter.BuyAgainViewHolder>() {

   inner class BuyAgainViewHolder(val binding: HistoryItemBinding) : RecyclerView.ViewHolder(binding.root) {
